...
QDirtyParser::ProgramContext* QDirtyParser::program() {
  ...
  try {
    ...
    do {
      ...
      _errHandler->sync(this);
      _la = _input->LA(1);
    } while (_la == QDirtyParser::T__0

    || _la == QDirtyParser::T__3);
...
QDirtyParser::ExprContext* QDirtyParser::expr(int precedence) {
  ...
  size_t startState = 4;
  enterRecursionRule(_localctx, 4, QDirtyParser::RuleExpr, precedence);
...
QDirtyParser::TermContext* QDirtyParser::term(int precedence) {
  ...
  (void)previousContext; // Silence compiler, in case the context is not used by generated code.
  size_t startState = 6;
  enterRecursionRule(_localctx, 6, QDirtyParser::RuleTerm, precedence);
...
QDirtyParser::FactorContext* QDirtyParser::factor() {
  ...
  enterRule(_localctx, 8, QDirtyParser::RuleFactor);
