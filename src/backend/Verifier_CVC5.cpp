...
Verifier_CVC5::Verifier_CVC5(const std::shared_ptr<Program>& program, 
...
std::shared_ptr<Verifier_CVC5> Verifier_CVC5::make_verifier(const std::shared_ptr<Program>& program, 
                                                           std::ostream& error_output) {
    return std::shared_ptr<Verifier_CVC5>(new Verifier_CVC5(program, error_output));
}



void Verifier_CVC5::interpret() {
    semantics_.clear();
    try {
